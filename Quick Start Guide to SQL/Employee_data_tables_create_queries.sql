...
INSERT INTO emp_tab 
VALUES(7001, 'KING', 'PRESIDENT', null, to_date('17-11-1981','dd-mm-yyyy'), 5000, null, 40 ;

INSERT INTO emp_tab 
VALUES(7002, 'CLARK', 'MANAGER', 7001, to_date('9-6-1981','dd-mm-yyyy'), 2450, null, 40 );

INSERT INTO emp_tab 
VALUES(7003, 'JONES', 'MANAGER', 7001, to_date('2-4-1981','dd-mm-yyyy'), 2975, null, 30 );

INSERT INTO emp_tab
VALUES(7004, 'SCOTT', 'ANALYST', 7002, to_date('13-JUL-87','dd-mm-rr') - 85, 3000, null, 70 );

INSERT INTO emp_tab 
VALUES(7005, 'FORD', 'ANALYST', 7002, to_date('3-12-1981','dd-mm-yyyy'), 3000, null, 30 );

INSERT INTO emp_tab
VALUES(7006, 'SMITH', 'CLERK', 7003, to_date('17-12-1980','dd-mm-yyyy'), 800, null, 30 );

INSERT INTO emp_tab 
VALUES(7007, 'ADAMS', 'CLERK', 7003, to_date('13-JUL-87', 'dd-mm-rr') - 51, 1100, null, 40 );

INSERT INTO emp_tab  
VALUES( 7008, 'MILLER', 'CLERK', 7003, to_date('23-1-1982','dd-mm-yyyy'), 1300, null, 30 );
